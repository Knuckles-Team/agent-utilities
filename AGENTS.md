...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1118 concepts across 9 pillars._
...
| **AU-OS** | 148 | audit, config, context, deployment, governance, host, identity, observability, safety, scaling, state |
| **EG-AHE** | 1 | harness |
