...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1062 concepts across 9 pillars._
...
| **AU-KG** | 454 | audit, backend, compute, coordination, domains, enrichment, epistemic, etl, evolution, identity, ingest, maintenance, memory, mining, ontology, query, research, retrieval, sharding, storage, temporal, txn |
