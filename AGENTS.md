...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1112 concepts across 9 pillars._
...
| **AU-OS** | 145 | audit, config, context, deployment, governance, host, identity, observability, safety, scaling, state |
| **EG-AHE** | 1 | harness |
