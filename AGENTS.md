...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1040 concepts across 9 pillars._

| Pillar | Count | Domains |
|:------|:---:|:------|
| **AU-AHE** | 115 | assimilation, evaluation, harness, optimization, org, reward, rlm, sdd, trainer |
| **AU-ECO** | 119 | bus, connector, interop, mcp, messaging, multiplexer, reactions, toolkit, ui |
| **AU-KG** | 444 | audit, backend, compute, coordination, domains, enrichment, epistemic, etl, evolution, identity, ingest, maintenance, memory, mining, ontology, query, research, retrieval, sharding, storage, temporal, txn |
