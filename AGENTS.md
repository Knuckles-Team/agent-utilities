...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 978 concepts across 8 pillars._

| Pillar | Count | Domains |
|:------|:---:|:------|
| **AU-AHE** | 102 | assimilation, evaluation, harness, optimization, org, reward, rlm, sdd, trainer |
| **AU-ECO** | 119 | bus, connector, interop, mcp, messaging, multiplexer, reactions, toolkit, ui |
| **AU-KG** | 418 | audit, backend, compute, coordination, domains, enrichment, etl, evolution, identity, ingest, maintenance, memory, mining, ontology, query, research, retrieval, sharding, storage, temporal, txn |
| **AU-ORCH** | 186 | adapter, dispatch, execution, optimization, org, planning, reactive, routing, runvcs, sandbox, scheduling, session, twin |
| **AU-OS** | 127 | audit, config, context, deployment, governance, host, identity, observability, safety, scaling, state |
| **EG-AHE** | 1 | harness |
| **EG-KG** | 24 | backend, compute, domains, enrichment, epistemic, graphlearn, ingest, memory, mining, query, sharding, storage, txn |
| **EG-ORCH** | 1 | routing |
