...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1114 concepts across 9 pillars._

| Pillar | Count | Domains |
|:------|:---:|:------|
| **AU-AHE** | 117 | assimilation, evaluation, harness, optimization, org, reward, rlm, sdd, trainer |
| **AU-ECO** | 126 | bus, connector, interop, mcp, messaging, multiplexer, reactions, toolkit, ui |
