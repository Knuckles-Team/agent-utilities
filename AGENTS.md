...
│   │   ├── orch-messaging-orchestration-transparency/
...
|:------|:---:|:------|
| **AU-AHE** | 114 | assimilation, evaluation, harness, optimization, org, reward, rlm, sdd, trainer |
| **AU-ECO** | 119 | bus, connector, interop, mcp, messaging, multiplexer, reactions, toolkit, ui |
| **AU-KG** | 442 | audit, backend, compute, coordination, domains, enrichment, epistemic, etl, evolution, identity, ingest, maintenance, memory, mining, ontology, query, research, retrieval, sharding, storage, temporal, txn |
...
| **EG-AHE** | 1 | harness |
| **EG-KG** | 28 | backend, compute, domains, enrichment, epistemic, graphlearn, ingest, memory, mining, ontology, query, sharding, storage, txn |
| **EG-ORCH** | 1 | routing |
| **EG-OS** | 1 | deployment |
