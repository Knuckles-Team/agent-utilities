...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1229 concepts across 9 pillars._
...
| **AU-ORCH** | 218 | adapter, dispatch, execution, optimization, org, planning, reactive, routing, runvcs, sandbox, scheduling, session, twin |
| **AU-OS** | 187 | audit, config, context, deployment, governance, host, identity, measurement, observability, safety, scaling, state |
| **EG-AHE** | 1 | harness |
