...
_Auto-generated from `docs/concepts.yaml` (single source of truth). 1128 concepts across 9 pillars._
...
| **AU-KG** | 483 | audit, backend, compute, coordination, domains, enrichment, epistemic, etl, evolution, identity, ingest, maintenance, memory, mining, ontology, query, research, retrieval, sharding, storage, temporal, trace, txn |
