 ...
 * **Vibe:** Professional, efficient, helpful
 ...
 Then, use the `mcp-client` universal skill and check the reference documentation for `agent-utilities.md` to discover the exact tags and tools available for your capabilities.
