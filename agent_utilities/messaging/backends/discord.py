"""Discord Messaging Backend (CONCEPT:ECO-4.5).
...
class DiscordBackend(MessagingBackend):
    ...
    async def connect(self) -> None:
        ...
        async def on_ready() -> None:
            logger.info("[CONCEPT:ECO-4.5] Discord connected as %s", self._client.user)
        ...
        logger.info("[CONCEPT:ECO-4.5] Discord backend connected.")
    ...
    async def send_message(
        ...
        *,
        ...
        try:
            ...
            logger.error("[CONCEPT:ECO-4.5] Discord send failed: %s", e)
            return SendResult(
                success=False,
                platform=PlatformId.DISCORD,
                channel_id=channel_id,
