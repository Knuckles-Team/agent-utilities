...
CONCEPT:AU-OS.governance.agents-md-reflector — Self-Improving AGENTS.md Reflector
    ...
    def _write_proposals(self, proposals: list[AgentsMdProposal]) -> None:
        ...
        if fp.exists():
            ...
            parts.append(
                ...
                "> Auto-generated by AGENTS.md Reflector (CONCEPT:AU-OS.governance.agents-md-reflector)\n"
            )
