...
"""Learned Agent Routing Policy (CONCEPT:AU-ORCH.routing.uno-orchestra-derived Enhancement).
...
class RoutingPrimitive(StrEnum):
    """Execution primitives available for routing (CONCEPT:AU-ORCH.routing.uno-orchestra-derived)."""
...
class RoutingDecision(BaseModel):
    """The result of a routing decision (CONCEPT:AU-ORCH.routing.uno-orchestra-derived).
    ...
    decision_reason: str = ""
    # CONCEPT:AU-ORCH.routing.route-inference-parameters — the inference-parameter bundle for this route, picked from the
...
class RoutingPolicy:
    """Base class for routing policies (CONCEPT:AU-ORCH.routing.uno-orchestra-derived).
...
class TraceLearnedPolicy(RoutingPolicy):
    ...
    CONCEPT:AU-ORCH.routing.uno-orchestra-derived — Derived from Uno-Orchestra's RL-trajectory approach.
...
class CostAwareRouter:
    """Cost-aware Pareto-optimal routing wrapper (CONCEPT:AU-ORCH.routing.uno-orchestra-derived).
...
class OntologicalFallbackChain:
    """Ontological Fallback Chains (CONCEPT:AU-ORCH.routing.uno-orchestra-derived).
...
class TopologicalRoutingPolicy(RoutingPolicy):
    ...
    CONCEPT:AU-ORCH.routing.topological-routing — Topological Routing
...
CONCEPT:AU-ORCH.execution.inject-signal-board-observations Dynamic agent spawning via a registry-driven factory.
...
def make_specialist_step(persona: SpecialistPersona):
    ...
    _specialist_step.__doc__ = (
        ...
        f"Auto-generated by the specialist factory (CONCEPT:AU-ORCH.execution.inject-signal-board-observations).\n\n"
        f"Args:\n"
