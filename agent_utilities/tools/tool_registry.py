...
def register_agent_tools(agent: Agent, graph_bundle: tuple | None = None) -> None:
    ...
    from .kg_evolution_tools import kg_evolution_tools
    from .kg_share_tools import kg_share_tools
    from .knowledge_tools import KB_TOOLS, knowledge_tools
    ...
    from .sdd_tools import sdd_tools
