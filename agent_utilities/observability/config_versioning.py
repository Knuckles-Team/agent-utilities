...
class AgentConfigSnapshot(BaseModel):
    """Immutable snapshot of an agent's configuration. CONCEPT:AHE-3.13.
...
class ConfigDiff(BaseModel):
    """Structured diff between two config versions. CONCEPT:AHE-3.13."""
...
class AgentConfigVersionManager:
    """Manages versioned agent configurations. CONCEPT:AHE-3.13.
