...
GRAPHOS_ACTIONS: list[GraphosAction] = [
    ...
    {"tool": "graph_bus", "action": "ack", "name": "graph_bus_ack"},
    {"tool": "graph_bus", "action": "deregister", "name": "graph_bus_deregister"},
    {"tool": "graph_bus", "action": "dispatch", "name": "graph_bus_dispatch"},
    {"tool": "graph_bus", "action": "federate", "name": "graph_bus_federate"},
    {"tool": "graph_bus", "action": "federate_in", "name": "graph_bus_federate_in"},
    {"tool": "graph_bus", "action": "heartbeat", "name": "graph_bus_heartbeat"},
    {"tool": "graph_bus", "action": "leave", "name": "graph_bus_leave"},
    {"tool": "graph_bus", "action": "list_hubs", "name": "graph_bus_list_hubs"},
    {"tool": "graph_bus", "action": "receive", "name": "graph_bus_receive"},
    {"tool": "graph_bus", "action": "register", "name": "graph_bus_register"},
    {"tool": "graph_bus", "action": "register_hub", "name": "graph_bus_register_hub"},
    {"tool": "graph_bus", "action": "roster", "name": "graph_bus_roster"},
    {"tool": "graph_bus", "action": "send", "name": "graph_bus_send"},
    {"tool": "graph_bus", "action": "status", "name": "graph_bus_status"},
    {"tool": "graph_bus", "action": "subscribe", "name": "graph_bus_subscribe"},
    {"tool": "graph_bus", "action": "unsubscribe", "name": "graph_bus_unsubscribe"},
