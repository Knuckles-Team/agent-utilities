...
GRAPHOS_ACTIONS: list[GraphosAction] = [
    ...
    },
    {
        "tool": "engine_admin",
        "action": "audit_verify",
        "name": "engine_admin_audit_verify",
    },
    ...
    {"tool": "engine_admin", "action": "restore", "name": "engine_admin_restore"},
    {
        ...
        "name": "engine_analytics_betweenness_centrality",
    },
    {
        "tool": "engine_analytics",
        "action": "degree_centrality",
        "name": "engine_analytics_degree_centrality",
    },
    {
        "tool": "engine_analytics",
        "action": "degree_centrality_all",
        "name": "engine_analytics_degree_centrality_all",
    },
    {
        "tool": "engine_analytics",
        "action": "pagerank",
        "name": "engine_analytics_pagerank",
    },
    {
        "tool": "engine_analytics",
        "action": "personalized_pagerank",
        "name": "engine_analytics_personalized_pagerank",
    },
    {"tool": "engine_blob", "action": "begin", "name": "engine_blob_begin"},
    {"tool": "engine_blob", "action": "chunk_get", "name": "engine_blob_chunk_get"},
    {"tool": "engine_blob", "action": "chunk_put", "name": "engine_blob_chunk_put"},
    {"tool": "engine_blob", "action": "commit", "name": "engine_blob_commit"},
    {"tool": "engine_blob", "action": "fetch", "name": "engine_blob_fetch"},
    {"tool": "engine_blob", "action": "fetch_begin", "name": "engine_blob_fetch_begin"},
    {"tool": "engine_blob", "action": "fetch_end", "name": "engine_blob_fetch_end"},
    {"tool": "engine_blob", "action": "gc", "name": "engine_blob_gc"},
    ...
    {
        "tool": "engine_channels",
        "action": "get_members",
        "name": "engine_channels_get_members",
    },
    {
        "tool": "engine_channels",
        "action": "get_messages",
        "name": "engine_channels_get_messages",
    },
    {"tool": "engine_channels", "action": "join", "name": "engine_channels_join"},
    {"tool": "engine_channels", "action": "leave", "name": "engine_channels_leave"},
    {"tool": "engine_channels", "action": "list", "name": "engine_channels_list"},
    {
        "tool": "engine_channels",
        "action": "send_message",
        "name": "engine_channels_send_message",
    },
    {
    ...
    },
    {
        "tool": "engine_consensus",
        "action": "get_identity",
        "name": "engine_consensus_get_identity",
    },
    {
        "tool": "engine_consensus",
        "action": "register_identity",
        "name": "engine_consensus_register_identity",
    },
    {
        "tool": "engine_datascience",
        "action": "adam_step",
        "name": "engine_datascience_adam_step",
    },
    {
        "tool": "engine_datascience",
        "action": "compute_stats",
        "name": "engine_datascience_compute_stats",
    },
    {
        "tool": "engine_datascience",
        "action": "cross_entropy",
        "name": "engine_datascience_cross_entropy",
    },
    {
        "tool": "engine_datascience",
        "action": "dpo_loss",
        "name": "engine_datascience_dpo_loss",
    },
    {
        "tool": "engine_datascience",
        "action": "fit_estimator",
        "name": "engine_datascience_fit_estimator",
    },
    {
        "tool": "engine_datascience",
        "action": "grpo_surrogate",
        "name": "engine_datascience_grpo_surrogate",
    },
    {
        "tool": "engine_datascience",
        "action": "kl_divergence",
        "name": "engine_datascience_kl_divergence",
    },
    {
        "tool": "engine_datascience",
        "action": "kmeans",
        "name": "engine_datascience_kmeans",
    },
    {
        "tool": "engine_datascience",
        "action": "linear_regression",
        "name": "engine_datascience_linear_regression",
    },
    {
        "tool": "engine_datascience",
        "action": "log_softmax",
        "name": "engine_datascience_log_softmax",
    },
    {"tool": "engine_datascience", "action": "pca", "name": "engine_datascience_pca"},
    {
        "tool": "engine_datascience",
        "action": "predict_estimator",
        "name": "engine_datascience_predict_estimator",
    },
    {
        "tool": "engine_datascience",
        "action": "sgd_step",
        "name": "engine_datascience_sgd_step",
    },
    {
        "tool": "engine_datascience",
        "action": "softmax",
        "name": "engine_datascience_softmax",
    },
    {
        "tool": "engine_datascience",
        "action": "train_test_split",
        "name": "engine_datascience_train_test_split",
    },
    {"tool": "engine_edges", "action": "add", "name": "engine_edges_add"},
    {"tool": "engine_edges", "action": "count", "name": "engine_edges_count"},
    ...
    {
        "tool": "engine_edges",
        "action": "properties_batch",
        "name": "engine_edges_properties_batch",
    },
    {"tool": "engine_edges", "action": "remove", "name": "engine_edges_remove"},
    {"tool": "engine_edges", "action": "supersede", "name": "engine_edges_supersede"},
    {"tool": "engine_finance", "action": "adf_test", "name": "engine_finance_adf_test"},
    {
        "tool": "engine_finance",
        "action": "alpha_combination_engine",
        "name": "engine_finance_alpha_combination_engine",
    },
    {
        "tool": "engine_finance",
        "action": "avellaneda_stoikov",
        "name": "engine_finance_avellaneda_stoikov",
    },
    {
        "tool": "engine_finance",
        "action": "bayesian_kelly",
        "name": "engine_finance_bayesian_kelly",
    },
    {
        "tool": "engine_finance",
        "action": "black_litterman",
        "name": "engine_finance_black_litterman",
    },
    {
        "tool": "engine_finance",
        "action": "breakeven_alpha",
        "name": "engine_finance_breakeven_alpha",
    },
    {
        "tool": "engine_finance",
        "action": "brier_score",
        "name": "engine_finance_brier_score",
    },
    {
        "tool": "engine_finance",
        "action": "combine_alphas",
        "name": "engine_finance_combine_alphas",
    },
    {
        "tool": "engine_finance",
        "action": "convergence_gate",
        "name": "engine_finance_convergence_gate",
    },
    {
        "tool": "engine_finance",
        "action": "cross_sectional_rank",
        "name": "engine_finance_cross_sectional_rank",
    },
    {"tool": "engine_finance", "action": "cvar", "name": "engine_finance_cvar"},
    {
        "tool": "engine_finance",
        "action": "deflated_sharpe",
        "name": "engine_finance_deflated_sharpe",
    },
    {
        "tool": "engine_finance",
        "action": "detect_regimes",
        "name": "engine_finance_detect_regimes",
    },
    {
        "tool": "engine_finance",
        "action": "diebold_mariano",
        "name": "engine_finance_diebold_mariano",
    },
    {
        "tool": "engine_finance",
        "action": "downside_deviation",
        "name": "engine_finance_downside_deviation",
    },
    {
        "tool": "engine_finance",
        "action": "drawdown_series",
        "name": "engine_finance_drawdown_series",
    },
    {
        "tool": "engine_finance",
        "action": "effective_independent_n",
        "name": "engine_finance_effective_independent_n",
    },
    {
        "tool": "engine_finance",
        "action": "efficient_frontier",
        "name": "engine_finance_efficient_frontier",
    },
    {
        "tool": "engine_finance",
    ...
    {"tool": "engine_finance", "action": "ewma", "name": "engine_finance_ewma"},
    {
        ...
        "name": "engine_finance_expected_pnl_rate",
    },
    {
        "tool": "engine_finance",
        "action": "forensic_report",
        "name": "engine_finance_forensic_report",
    },
    {
        "tool": "engine_finance",
        "action": "glosten_milgrom_spread",
        "name": "engine_finance_glosten_milgrom_spread",
    },
    {
        "tool": "engine_finance",
        "action": "glt_quotes",
        "name": "engine_finance_glt_quotes",
    },
    {
        "tool": "engine_finance",
        "action": "hardiman_bouchaud",
        "name": "engine_finance_hardiman_bouchaud",
    },
    {
        "tool": "engine_finance",
        "action": "hawkes_mle",
        "name": "engine_finance_hawkes_mle",
    },
    {
        "tool": "engine_finance",
        "action": "information_coefficient",
        "name": "engine_finance_information_coefficient",
    },
    {
        "tool": "engine_finance",
        "action": "information_ratio",
        "name": "engine_finance_information_ratio",
    },
    {
        "tool": "engine_finance",
        "action": "kalman_beta",
        "name": "engine_finance_kalman_beta",
    },
    {
        "tool": "engine_finance",
        "action": "kalman_filter_1d",
        "name": "engine_finance_kalman_filter_1d",
    },
    {
        "tool": "engine_finance",
        "action": "kalman_volatility",
        "name": "engine_finance_kalman_volatility",
    },
    {
        "tool": "engine_finance",
        "action": "kelly_fraction",
        "name": "engine_finance_kelly_fraction",
    },
    {
        "tool": "engine_finance",
        "action": "kyle_lambda",
        "name": "engine_finance_kyle_lambda",
    },
    {
        "tool": "engine_finance",
        "action": "logit_quotes",
    ...
    },
    {
        ...
        "name": "engine_finance_market_impact",
    },
    {
        "tool": "engine_finance",
        "action": "markov_transition_matrix",
        "name": "engine_finance_markov_transition_matrix",
    },
    {
        "tool": "engine_finance",
        "action": "match_orders",
        "name": "engine_finance_match_orders",
    },
    {
        "tool": "engine_finance",
        "action": "max_drawdown",
        "name": "engine_finance_max_drawdown",
    },
    {
        "tool": "engine_finance",
        "action": "mean_reversion",
        "name": "engine_finance_mean_reversion",
    },
    {
        "tool": "engine_finance",
        "action": "microprice_series",
        "name": "engine_finance_microprice_series",
    },
    {"tool": "engine_finance", "action": "momentum", "name": "engine_finance_momentum"},
    {
        "tool": "engine_finance",
        "action": "monte_carlo_var",
        "name": "engine_finance_monte_carlo_var",
    },
    {
        "tool": "engine_finance",
        "action": "ofi_series",
        "name": "engine_finance_ofi_series",
    },
    {
        "tool": "engine_finance",
        "action": "optimize_portfolio",
        "name": "engine_finance_optimize_portfolio",
    },
    {
        "tool": "engine_finance",
        "action": "order_book_imbalance",
        "name": "engine_finance_order_book_imbalance",
    },
    {
        "tool": "engine_finance",
        "action": "ou_calibrate",
        "name": "engine_finance_ou_calibrate",
    },
    {
        "tool": "engine_finance",
        "action": "ou_optimal_thresholds",
        "name": "engine_finance_ou_optimal_thresholds",
    },
    {
        "tool": "engine_finance",
        "action": "pairs_trading",
        "name": "engine_finance_pairs_trading",
    },
    {
        "tool": "engine_finance",
        "action": "posterior_credible_interval",
        "name": "engine_finance_posterior_credible_interval",
    },
    {
        "tool": "engine_finance",
        "action": "probability_backtest_overfit",
        "name": "engine_finance_probability_backtest_overfit",
    },
    {
        "tool": "engine_finance",
        "action": "purged_cpcv",
        "name": "engine_finance_purged_cpcv",
    },
    {
        "tool": "engine_finance",
        "action": "queue_imbalance",
        "name": "engine_finance_queue_imbalance",
    },
    {
        "tool": "engine_finance",
        "action": "realized_vol_tick",
        "name": "engine_finance_realized_vol_tick",
    },
    {
        "tool": "engine_finance",
        "action": "risk_metrics",
        "name": "engine_finance_risk_metrics",
    },
    {
        "tool": "engine_finance",
        "action": "risk_parity",
        "name": "engine_finance_risk_parity",
    },
    {
        "tool": "engine_finance",
    ...
    {
        "tool": "engine_finance",
        "action": "sabr_implied_vol",
        "name": "engine_finance_sabr_implied_vol",
    },
    {
        "tool": "engine_finance",
        "action": "sabr_smile",
        "name": "engine_finance_sabr_smile",
    },
    {
        "tool": "engine_finance",
        "action": "signal_decay",
    ...
    },
    {
        ...
        "name": "engine_finance_spread_reversion",
    },
    {
        "tool": "engine_finance",
        "action": "stress_test",
        "name": "engine_finance_stress_test",
    },
    {
        "tool": "engine_finance",
        "action": "surveillance_risk",
        "name": "engine_finance_surveillance_risk",
    },
    {"tool": "engine_finance", "action": "twap", "name": "engine_finance_twap"},
    {"tool": "engine_finance", "action": "var", "name": "engine_finance_var"},
    {"tool": "engine_finance", "action": "vpin_pm", "name": "engine_finance_vpin_pm"},
    {"tool": "engine_finance", "action": "vwap", "name": "engine_finance_vwap"},
    {
        "tool": "engine_graph",
        "action": "add_embedding",
        "name": "engine_graph_add_embedding",
    },
    {
        "tool": "engine_graph",
    ...
    },
    {
        "tool": "engine_graph",
        "action": "blast_radius",
        "name": "engine_graph_blast_radius",
    },
    {"tool": "engine_graph", "action": "clear", "name": "engine_graph_clear"},
    {
        "tool": "engine_graph",
        "action": "cluster_hierarchy_clusters",
        "name": "engine_graph_cluster_hierarchy_clusters",
    },
    {
        "tool": "engine_graph",
        "action": "cluster_hierarchy_expand",
        "name": "engine_graph_cluster_hierarchy_expand",
    },
    {
        "tool": "engine_graph",
        "action": "cluster_hierarchy_refresh",
        "name": "engine_graph_cluster_hierarchy_refresh",
    },
    {
        "tool": "engine_graph",
        "action": "community_detect_ephemeral",
        "name": "engine_graph_community_detect_ephemeral",
    },
    {
        "tool": "engine_graph",
        "action": "community_detection",
        "name": "engine_graph_community_detection",
    },
    {
        "tool": "engine_graph",
        "action": "compute_similarity_edges",
        "name": "engine_graph_compute_similarity_edges",
    },
    {
        "tool": "engine_graph",
        "action": "connected_components",
        "name": "engine_graph_connected_components",
    },
    {"tool": "engine_graph", "action": "discover", "name": "engine_graph_discover"},
    ...
    },
    {
        ...
        "name": "engine_graph_index_repository",
    },
    {
        "tool": "engine_graph",
        "action": "match_ontology_terms",
        "name": "engine_graph_match_ontology_terms",
    },
    {
        "tool": "engine_graph",
        "action": "minimum_spanning_tree",
        "name": "engine_graph_minimum_spanning_tree",
    },
    {
        "tool": "engine_graph",
        "action": "observe_screen",
        "name": "engine_graph_observe_screen",
    },
    {"tool": "engine_graph", "action": "parse_file", "name": "engine_graph_parse_file"},
    {
        "tool": "engine_graph",
        "action": "parse_files",
        "name": "engine_graph_parse_files",
    },
    {
        "tool": "engine_graph",
    ...
    },
    {
        ...
        "name": "engine_graph_semantic_search",
    },
    {
        "tool": "engine_graph",
    ...
    {
        "tool": "engine_graph",
        "action": "strongly_connected_components",
        "name": "engine_graph_strongly_connected_components",
    },
    {
        "tool": "engine_graph",
        "action": "topological_sort",
        "name": "engine_graph_topological_sort",
    },
    {
        "tool": "engine_graph",
    ...
    {
        "tool": "engine_ledger",
        "action": "get_with_watermark",
        "name": "engine_ledger_get_with_watermark",
    },
    {
        "tool": "engine_lifecycle",
        "action": "batch_update",
        "name": "engine_lifecycle_batch_update",
    },
    {
        "tool": "engine_lifecycle",
        "action": "decay_sweep",
        "name": "engine_lifecycle_decay_sweep",
    },
    {
        "tool": "engine_lifecycle",
        "action": "evict_lru",
        "name": "engine_lifecycle_evict_lru",
    },
    {
        "tool": "engine_lifecycle",
        "action": "from_msgpack",
        "name": "engine_lifecycle_from_msgpack",
    },
    {
        "tool": "engine_lifecycle",
        "action": "get_context_view",
        "name": "engine_lifecycle_get_context_view",
    },
    {
        "tool": "engine_lifecycle",
        "action": "metrics",
    ...
    {"tool": "engine_lifecycle", "action": "prune", "name": "engine_lifecycle_prune"},
    {
        "tool": "engine_lifecycle",
        "action": "to_msgpack",
        "name": "engine_lifecycle_to_msgpack",
    },
    {
        "tool": "engine_lifecycle",
        "action": "touch_nodes",
    ...
    {
        "tool": "engine_modalities",
        "action": "authority",
        "name": "engine_modalities_authority",
    },
    {
        "tool": "engine_modalities",
        "action": "capabilities",
        "name": "engine_modalities_capabilities",
    },
    {
        "tool": "engine_modalities",
        "action": "collect_tombstones",
        "name": "engine_modalities_collect_tombstones",
    },
    {
        "tool": "engine_modalities",
        "action": "delete",
        "name": "engine_modalities_delete",
    },
    {
        "tool": "engine_modalities",
        "action": "events",
        "name": "engine_modalities_events",
    },
    {
        "tool": "engine_modalities",
        "action": "ingest",
        "name": "engine_modalities_ingest",
    },
    {
        "tool": "engine_modalities",
        "action": "ingest_stream",
        "name": "engine_modalities_ingest_stream",
    },
    {
        "tool": "engine_modalities",
        "action": "move_to_cold",
        "name": "engine_modalities_move_to_cold",
    },
    {"tool": "engine_modalities", "action": "query", "name": "engine_modalities_query"},
    {
        "tool": "engine_modalities",
        "action": "query_audio_window",
        "name": "engine_modalities_query_audio_window",
    },
    {
        "tool": "engine_modalities",
        "action": "query_image_region",
        "name": "engine_modalities_query_image_region",
    },
    {
        "tool": "engine_modalities",
        "action": "query_similar_images",
        "name": "engine_modalities_query_similar_images",
    },
    {
        "tool": "engine_modalities",
        "action": "query_video_window",
        "name": "engine_modalities_query_video_window",
    },
    {
        "tool": "engine_modalities",
        "action": "restore",
        "name": "engine_modalities_restore",
    },
    {
        "tool": "engine_modalities",
        "action": "search_documents",
        "name": "engine_modalities_search_documents",
    },
    {"tool": "engine_modalities", "action": "stats", "name": "engine_modalities_stats"},
    ...
    {"tool": "engine_nodes", "action": "in_degree", "name": "engine_nodes_in_degree"},
    {"tool": "engine_nodes", "action": "list", "name": "engine_nodes_list"},
    {
        "tool": "engine_nodes",
        "action": "list_by_label",
        "name": "engine_nodes_list_by_label",
    },
    {
        "tool": "engine_nodes",
        "action": "list_by_label_union",
        "name": "engine_nodes_list_by_label_union",
    },
    ...
    {"tool": "engine_nodes", "action": "out_degree", "name": "engine_nodes_out_degree"},
    {
        "tool": "engine_nodes",
        "action": "predecessors",
        "name": "engine_nodes_predecessors",
    },
    {"tool": "engine_nodes", "action": "properties", "name": "engine_nodes_properties"},
    {
        "tool": "engine_nodes",
        "action": "properties_batch",
        "name": "engine_nodes_properties_batch",
    },
    {
        "tool": "engine_nodes",
        "action": "properties_union",
        "name": "engine_nodes_properties_union",
    },
    ...
    },
    {
        ...
        "name": "engine_query_export_sqlite_file",
    },
    {"tool": "engine_query", "action": "graphql", "name": "engine_query_graphql"},
    {
        "tool": "engine_query",
    ...
    {
        "tool": "engine_query",
        "action": "sql_source_batch",
        "name": "engine_query_sql_source_batch",
    },
    {
        "tool": "engine_query",
        "action": "stale_materializations",
        "name": "engine_query_stale_materializations",
    },
    ...
    {
        "tool": "engine_rdf",
        "action": "icv_configure",
        "name": "engine_rdf_icv_configure",
    },
    {"tool": "engine_rdf", "action": "owl_reason", "name": "engine_rdf_owl_reason"},
    {
        "tool": "engine_rdf",
        "action": "owl_reason_distributed",
        "name": "engine_rdf_owl_reason_distributed",
    },
    {
        "tool": "engine_rdf",
        "action": "remove_triples",
    ...
    {"tool": "engine_reasoning", "action": "reason", "name": "engine_reasoning_reason"},
    {
        ...
        "action": "catalog_assign",
        "name": "engine_resharding_catalog_assign",
    },
    {
        "tool": "engine_resharding",
        "action": "catalog_list",
        "name": "engine_resharding_catalog_list",
    },
    {
        "tool": "engine_resharding",
        "action": "catalog_reassign",
        "name": "engine_resharding_catalog_reassign",
    },
    {
        "tool": "engine_resharding",
        "action": "catalog_remove",
        "name": "engine_resharding_catalog_remove",
    },
    {
        "tool": "engine_resharding",
        "action": "rebalance_execute",
        "name": "engine_resharding_rebalance_execute",
    },
    {
        "tool": "engine_resharding",
        "action": "rebalance_plan",
        "name": "engine_resharding_rebalance_plan",
    },
    {
        "tool": "engine_resharding",
        "action": "reshard",
        "name": "engine_resharding_reshard",
    },
    {
        "tool": "engine_streaming",
        "action": "cdc_read",
        "name": "engine_streaming_cdc_read",
    },
    {
        "tool": "engine_streaming",
        "action": "cdc_read_with_watermark",
        "name": "engine_streaming_cdc_read_with_watermark",
    },
    {
        "tool": "engine_streaming",
        "action": "cep_poll",
        "name": "engine_streaming_cep_poll",
    },
    {
        "tool": "engine_streaming",
        "action": "cep_subscribe",
        "name": "engine_streaming_cep_subscribe",
    },
    {
        "tool": "engine_streaming",
        "action": "cep_unsubscribe",
        "name": "engine_streaming_cep_unsubscribe",
    },
    {
        "tool": "engine_streaming",
        "action": "drop_continuous_query",
        "name": "engine_streaming_drop_continuous_query",
    },
    {
        "tool": "engine_streaming",
        "action": "drop_trigger",
        "name": "engine_streaming_drop_trigger",
    },
    {
        "tool": "engine_streaming",
        "action": "fired_triggers",
        "name": "engine_streaming_fired_triggers",
    },
    {
        "tool": "engine_streaming",
        "action": "list_triggers",
        "name": "engine_streaming_list_triggers",
    },
    {
        "tool": "engine_streaming",
        "action": "read_continuous_query",
        "name": "engine_streaming_read_continuous_query",
    },
    {
        "tool": "engine_streaming",
        "action": "register_continuous_query",
        "name": "engine_streaming_register_continuous_query",
    },
    {
        "tool": "engine_streaming",
        "action": "register_trigger",
        "name": "engine_streaming_register_trigger",
    },
    {"tool": "engine_streaming", "action": "watch", "name": "engine_streaming_watch"},
    {"tool": "engine_tenants", "action": "create", "name": "engine_tenants_create"},
    {"tool": "engine_tenants", "action": "delete", "name": "engine_tenants_delete"},
    {"tool": "engine_tenants", "action": "list", "name": "engine_tenants_list"},
    {
        "tool": "engine_timeseries",
        "action": "append",
        "name": "engine_timeseries_append",
    },
    {
        "tool": "engine_timeseries",
        "action": "asof_join",
        "name": "engine_timeseries_asof_join",
    },
    {
        "tool": "engine_timeseries",
    ...
    },
    {
        "tool": "engine_timeseries",
        "action": "evict_before",
        "name": "engine_timeseries_evict_before",
    },
    {
        "tool": "engine_timeseries",
        "action": "gap_fill",
        "name": "engine_timeseries_gap_fill",
    },
    {
        "tool": "engine_timeseries",
        "action": "list_series",
        "name": "engine_timeseries_list_series",
    },
    {"tool": "engine_timeseries", "action": "range", "name": "engine_timeseries_range"},
    {
        "tool": "engine_timeseries",
        "action": "register_series",
        "name": "engine_timeseries_register_series",
    },
    {
        "tool": "engine_timeseries",
        "action": "window",
        "name": "engine_timeseries_window",
    },
    {"tool": "engine_txn", "action": "add_edge", "name": "engine_txn_add_edge"},
    {
        "tool": "engine_txn",
        "action": "add_embedding",
        "name": "engine_txn_add_embedding",
    },
    {
        "tool": "engine_txn",
        "action": "add_measurement",
        "name": "engine_txn_add_measurement",
    },
    {"tool": "engine_txn", "action": "add_node", "name": "engine_txn_add_node"},
    {"tool": "engine_txn", "action": "axiom", "name": "engine_txn_axiom"},
    {"tool": "engine_txn", "action": "begin", "name": "engine_txn_begin"},
    {"tool": "engine_txn", "action": "blob_ref", "name": "engine_txn_blob_ref"},
    {"tool": "engine_txn", "action": "cas", "name": "engine_txn_cas"},
    {"tool": "engine_txn", "action": "commit", "name": "engine_txn_commit"},
    {
        "tool": "engine_txn",
        "action": "commit_with_outcome",
        "name": "engine_txn_commit_with_outcome",
    },
    ...
    },
    {
        ...
        "name": "engine_viz_capability_matrix",
    },
    {"tool": "engine_viz", "action": "render", "name": "engine_viz_render"},
    ...
    {"tool": "graph_claims", "action": "retract", "name": "graph_claims_retract"},
    {"tool": "graph_claims", "action": "validate", "name": "graph_claims_validate"},
    {"tool": "graph_code", "action": "adr", "name": "graph_code_adr"},
    {"tool": "graph_code", "action": "arch_report", "name": "graph_code_arch_report"},
    {"tool": "graph_code", "action": "blast_radius", "name": "graph_code_blast_radius"},
    {"tool": "graph_code", "action": "call_graph", "name": "graph_code_call_graph"},
    {
        "tool": "graph_code",
        "action": "change_coupling",
        "name": "graph_code_change_coupling",
    },
    {"tool": "graph_code", "action": "code_context", "name": "graph_code_code_context"},
    {
        "tool": "graph_code",
        "action": "code_evolution",
        "name": "graph_code_code_evolution",
    },
    {"tool": "graph_code", "action": "code_metrics", "name": "graph_code_code_metrics"},
    {
        "tool": "graph_code",
        "action": "cross_repo_usages",
        "name": "graph_code_cross_repo_usages",
    },
    {"tool": "graph_code_nav", "action": "connects", "name": "graph_code_nav_connects"},
    {"tool": "graph_code", "action": "routes", "name": "graph_code_routes"},
    {"tool": "graph_code", "action": "similar_code", "name": "graph_code_similar_code"},
    ...
    },
    {
        ...
        "name": "graph_configure_approve_connection_mapping",
    },
    {
        "tool": "graph_configure",
    ...
    },
    {
        ...
        "name": "graph_configure_connection_mapping_status",
    },
    {
        "tool": "graph_configure",
        "action": "discover_connection_schema",
        "name": "graph_configure_discover_connection_schema",
    },
    {"tool": "graph_configure", "action": "doctor", "name": "graph_configure_doctor"},
    {
        "tool": "graph_configure",
        "action": "external_graph_doctor",
        "name": "graph_configure_external_graph_doctor",
    },
    {
        "tool": "graph_configure",
    ...
    },
    {
        ...
        "name": "graph_configure_propose_connection_mapping",
    },
    {
        "tool": "graph_configure",
    ...
    {
        "tool": "graph_domain_ops",
        "action": "allocate_budget",
        "name": "graph_domain_ops_allocate_budget",
    },
    {
        "tool": "graph_domain_ops",
        "action": "fit_markov_regime",
        "name": "graph_domain_ops_fit_markov_regime",
    },
    {
        "tool": "graph_domain_ops",
    ...
    {"tool": "graph_evaluate", "action": "causal", "name": "graph_evaluate_causal"},
    {
        ...
        "name": "graph_evaluate_check_constraints",
    },
    ...
    {"tool": "graph_evaluate", "action": "forecast", "name": "graph_evaluate_forecast"},
    {
        "tool": "graph_evaluate",
        "action": "guard_corpus",
        "name": "graph_evaluate_guard_corpus",
    },
    {
        "tool": "graph_evaluate",
        "action": "harness_gate",
        "name": "graph_evaluate_harness_gate",
    },
    {
        "tool": "graph_evaluate",
        "action": "invariant",
        "name": "graph_evaluate_invariant",
    },
    {
        "tool": "graph_evaluate",
        "action": "latent_efficiency_benchmark",
        "name": "graph_evaluate_latent_efficiency_benchmark",
    },
    {
        "tool": "graph_evaluate",
        "action": "quant_crypto",
        "name": "graph_evaluate_quant_crypto",
    },
    {
        "tool": "graph_evaluate",
    ...
    },
    {
        ...
        "name": "graph_evaluate_quant_microstructure",
    },
    {
        "tool": "graph_evaluate",
        "action": "quant_regime",
    ...
    },
    {
        "tool": "graph_evaluate",
        "action": "specialize",
        "name": "graph_evaluate_specialize",
    },
    {
        "tool": "graph_evaluate",
        "action": "world_model_rollout",
        "name": "graph_evaluate_world_model_rollout",
    },
    {
        "tool": "graph_evolution",
        "action": "assimilate",
        "name": "graph_evolution_assimilate",
    },
    {
        "tool": "graph_evolution",
        "action": "audit_scan",
    ...
    },
    {
        ...
        "name": "graph_evolution_failure_ingest",
    },
    {
        "tool": "graph_evolution",
        "action": "optimize_component",
        "name": "graph_evolution_optimize_component",
    },
    {
        "tool": "graph_evolution",
        "action": "publish_proposal",
        "name": "graph_evolution_publish_proposal",
    },
    {
        "tool": "graph_evolution",
        "action": "standardize",
        "name": "graph_evolution_standardize",
    },
    {"tool": "graph_explain", "action": "context", "name": "graph_explain_context"},
    {
        "tool": "graph_explain",
    ...
    {"tool": "graph_fork", "action": None, "name": "graph_fork"},
    {"tool": "graph_gis", "action": None, "name": "graph_gis"},
    ...
    {"tool": "graph_goals", "action": "list", "name": "graph_goals_list"},
    {
        ...
        "name": "graph_governance_claim_ownership",
    },
    {
        "tool": "graph_governance",
    ...
    },
    {
        ...
        "name": "graph_governance_submit_risk_veto",
    },
    {
        "tool": "graph_governance",
    ...
    {"tool": "graph_ingest", "action": "clear", "name": "graph_ingest_clear"},
    {
        ...
        "name": "graph_ingest_cohort_create",
    },
    {
        "tool": "graph_ingest",
        "action": "cohort_status",
        "name": "graph_ingest_cohort_status",
    },
    ...
    {
        "tool": "graph_ingest",
        "action": "enrich_pending_documents",
        "name": "graph_ingest_enrich_pending_documents",
    },
    {
        "tool": "graph_ingest",
        "action": "extract_jobs",
    ...
    {
        "tool": "graph_ingest",
        "action": "fleet_relevance",
        "name": "graph_ingest_fleet_relevance",
    },
    {
        "tool": "graph_ingest",
        "action": "gitlab_sync",
    ...
    {
        "tool": "graph_observe",
        "action": "prompt_regression",
        "name": "graph_observe_prompt_regression",
    },
    {
        "tool": "graph_observe",
        "action": "trace_rootcause",
        "name": "graph_observe_trace_rootcause",
    },
    ...
    {"tool": "graph_runvcs", "action": "fork", "name": "graph_runvcs_fork"},
    {"tool": "graph_runvcs", "action": "list", "name": "graph_runvcs_list"},
    ...
    {"tool": "graph_secret", "action": "delete", "name": "graph_secret_delete"},
    {"tool": "graph_secret", "action": "get", "name": "graph_secret_get"},
    {"tool": "graph_secret", "action": "list", "name": "graph_secret_list"},
    {"tool": "graph_secret", "action": "set", "name": "graph_secret_set"},
    ...
    {"tool": "graph_sessions", "action": "topology", "name": "graph_sessions_topology"},
    {
        "tool": "graph_share",
        "action": "clear_parent",
        "name": "graph_share_clear_parent",
    },
    {"tool": "graph_share", "action": "commons", "name": "graph_share_commons"},
    {"tool": "graph_share", "action": "hierarchy", "name": "graph_share_hierarchy"},
    ...
    {"tool": "graph_share", "action": "set_parent", "name": "graph_share_set_parent"},
    {"tool": "graph_table", "action": "create", "name": "graph_table_create"},
    {"tool": "graph_table", "action": "drop", "name": "graph_table_drop"},
    {"tool": "graph_table", "action": "ingest", "name": "graph_table_ingest"},
    {"tool": "graph_table", "action": "list", "name": "graph_table_list"},
    {"tool": "graph_table", "action": "query", "name": "graph_table_query"},
    ...
    {"tool": "graph_workflows", "action": "compile", "name": "graph_workflows_compile"},
    {
        ...
        "name": "graph_workflows_compile_process",
    },
    {
        "tool": "graph_workflows",
        "action": "dispatch",
    ...
    {"tool": "usage_query", "action": "series", "name": "usage_query_series"},
    {
        "tool": "usage_query",
    ...
    {"tool": "usage_query", "action": "traces", "name": "usage_query_traces"},
