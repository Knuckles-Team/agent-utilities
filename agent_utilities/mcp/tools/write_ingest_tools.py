        ...
        try:
            if action == "ingest":
                ...
                if not papers and not repos:
                    return (
                        "Error: cohort_create needs base_path=<JSON list of paper "
