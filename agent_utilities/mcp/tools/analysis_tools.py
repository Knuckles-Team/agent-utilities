    ...
    async def graph_orchestrate(
        ...
        try:
            ...
            if action == "dispatch":
                ...
                # Connector → skill synthesis (CONCEPT:KG-2.82/2.83): turn the
