...
class RegistryNodeType(StrEnum):
    ...
    # Microstructure alpha with measured priors (CONCEPT:EE-033)
    ...
    # Task-aware inference (CONCEPT:KG-2.94). A configured LLM (MODEL) carries a
...
class RegistryEdgeType(StrEnum):
    ...
    # Task-aware inference edges (CONCEPT:KG-2.95). HAS_PROFILE: a Model carries an
