...
SCHEMA = GraphSchemaDefinition(
    nodes=[
        ...
        TableDefinition(
            ...
            columns={
                ...
                "source": "STRING",
                "recoverable": "BOOLEAN",
                "privacy_redactions": "INT64",
                "privacy_categories": "STRING[]",
                "provenance_verified": "BOOLEAN",
                "provenance_faithfulness": "FLOAT",
                "provenance_verifier": "STRING",
                "importance_score": "FLOAT",
                "timestamp": "STRING",
                "metadata": "STRING",
                "is_permanent": "BOOLEAN",
        ...
        TableDefinition(
            ...
            columns={
                ...
                "args": "STRING",
                "args_digest": "STRING",
                "args_character_count": "INT64",
                "result": "STRING",
                "result_digest": "STRING",
                "result_character_count": "INT64",
                "error": "STRING",
                "error_digest": "STRING",
        ...
        TableDefinition(
            ...
            columns={
                ...
                "feedback_character_count": "INT64",
                "event_sequence": "INT64",
                "event_cursor": "INT64",
                "privacy_schema": "STRING",
                "privacy_redactions": "INT64",
        ...
        TableDefinition(
            ...
            columns={
                ...
                "prio_bucket": "INT64",
                "deadline_unix": "DOUBLE",
                "budget": "DOUBLE",
                "resource_class": "STRING",
                "fairness_group": "STRING",
                "attempt": "INT64",
                "max_attempts": "INT64",
                "backoff_base_s": "DOUBLE",
                "next_retry_at": "DOUBLE",
                "lease_owner": "STRING",
                "lease_epoch": "INT64",
                "fencing_token": "INT64",
    ...
    edges=[
        ...
        RelDefinition(
            type="USED_TOOL",
            connections=[{"from": "RunTrace", "to": "ToolCall"}],
        ),
        RelDefinition(
        ...
        RelDefinition(
            ...
            connections=[
                {"from": "RunTrace", "to": "OutcomeEvaluation"},
        ...
        RelDefinition(
            ...
            connections=[
                {"from": "WorkItem", "to": "Agent"},
                {"from": "WorkItem", "to": "SpawnedAgent"},
            ],
        ),
        RelDefinition(
            type="BLOCKED_BY_TASK",
            connections=[{"from": "WorkItem", "to": "WorkItem"}],
        ),
        RelDefinition(
            type="BELONGS_TO_TEAM",
            connections=[
                {"from": "WorkItem", "to": "Team"},
                {"from": "Agent", "to": "Team"},
