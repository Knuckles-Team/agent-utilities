...
CONCEPT:AU-ORCH.dispatch.queue-agent-dispatch
...
# arbitration (``engine_tasks.TaskManagerMixin``). New ingestion submissions
# create the WorkItem at intake.
...
def ingest_task_work_item_id(job_id: str) -> str:
    """Deterministic WorkItem id for an ingestion job id."""
...
def ingest_task_job_id_from_work_item_id(work_item_id: str) -> str | None:
    ...
    The inverse is used only to render the public job id from the sole WorkItem.
    """
