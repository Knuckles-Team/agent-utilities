...
CONCEPT:AU-KG.research.research-pipeline-runner — Optimal Execution Engine
...
class AlmgrenChrissDiscrete:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Almgren-Chriss Discrete (Oxford HFT Ch 3)
...
class AlmgrenChrissContinuous:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Almgren-Chriss Continuous (Oxford HFT Ch 4)
...
class CarteaJaimungalExecutor:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Cartea-Jaimungal (Oxford HFT Ch 5)
...
class AvellanedaStoikovMarketMaker:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Optimal Market Making (Oxford HFT Ch 10)
...
class CointegrationPairsTrader:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Cointegration Pairs Trading (Oxford HFT Ch 12)
...
class SignalAdaptiveExecutor:
    ...
    CONCEPT:AU-KG.research.research-pipeline-runner — Signal-Adaptive Execution (Oxford HFT Ch 7)
