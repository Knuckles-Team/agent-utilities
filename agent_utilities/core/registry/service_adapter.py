...
_SERVICE_DEFINITIONS: list[dict[str, str]] = [
    ...
    {
        "module": "agent_utilities.core.checkpoint.manager",
        "entry": "KGBackend",
    ...
    # --- Layer 5: Research Pipeline ---
    {
        ...
        "layer": "research",
        "domain": "general",
        "desc": "End-to-end research ingestion (KG-2.7)",
    },
    {
    ...
    # --- Synthesized Engine Facades ---
    {
        ...
        "layer": "observability",
        "domain": "general",
        "desc": "Audit + token tracking facade (OS-5.5/5.7/5.9)",
    },
    {
    ...
    },
    {
        ...
        "layer": "research",
        "domain": "general",
        "desc": "Pipeline + citation + orchestration (KG-2.7/2.33/2.39)",
    },
    {
