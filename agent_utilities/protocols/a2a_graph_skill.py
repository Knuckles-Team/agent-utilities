...
"""CONCEPT:AU-ECO.interop.a2a-native-planner — A2A-Native PlannerAgent (Graph-Backed Skill).
...
See docs/pillars/architecture_c4.md §CONCEPT:AU-ECO.interop.a2a-native-planner
"""
...
class PlannerGraphSkill:
    ...
    CONCEPT:AU-ECO.interop.a2a-native-planner — A2A-Native PlannerAgent
...
class CoordinatedGraphSkill(PlannerGraphSkill):
    ...
    CONCEPT:AU-ECO.interop.a2a-native-planner — Research: 2605.03310v1, social_theory
    ...
    async def run(self, messages: list[dict[str, Any]], context: Any = None) -> str:
        ...
        CONCEPT:AU-ECO.interop.a2a-native-planner — Research: 2605.03310v1
        ...
        # CONCEPT:AU-ORCH.execution.coordination-negotiation — Coordination negotiation before execution
