...
MARKER_RE = re.compile(
    r"CONCEPT:(?P<id>[A-Z]+-\d+(?:\.[0-9A-Za-z]+)?)(?P<rest>[^\n]*)"
)
...
def build() -> dict:
    ...
    ordered = [
        concepts[cid]
        for cid in sorted(concepts, key=_concept_sort_key)
    ]
...
def main() -> None:
    ...
    with OUT_PATH.open("w", encoding="utf-8") as fh:
        fh.write("# AUTO-GENERATED by scripts/build_concepts_yaml.py — DO NOT EDIT BY HAND.\n")
