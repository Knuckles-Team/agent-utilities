...
$auVersion = if ($env:AGENT_UTILITIES_VERSION) { $env:AGENT_UTILITIES_VERSION } else { '2.5.0' }
$skillsVersion = if ($env:UNIVERSAL_SKILLS_VERSION) { $env:UNIVERSAL_SKILLS_VERSION } else { '1.3.1' }
