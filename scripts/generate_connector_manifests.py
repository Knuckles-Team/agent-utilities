...
def build_manifest(
    ...
    *,
    ...
    unsigned_provenance = ProvenanceSpec(
        ...
        signature=None,
        # Which commit of the CONNECTOR's OWN repo produced this manifest -- nothing
        # more (replaces the old signed dependency_lock_digest pin, GOC-84/GOC-16,
        # removed: it made every dependency addition a release-Job-gated operation
        # for no benefit here).
        source_commit=ontology_integrity.repository_commit_sha(connector_root),
    )
