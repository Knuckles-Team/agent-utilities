...
with open('/home/apps/workspace/agent-packages/agent-utilities/docs/overview.md', 'r') as f:
    content = f.read()
...
for row in rows:
    ...
    for path in path_list:
        full_path = os.path.join('/home/apps/workspace/agent-packages/agent-utilities', path)
