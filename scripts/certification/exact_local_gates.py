...
CERTIFICATION_TESTS = (
    ...
    "unit/mcp/test_intent_surface_gating.py",
    "unit/core/test_provider_materialization.py",
    "unit/security/test_permissions_kernel.py",
...
def _campaign(args: argparse.Namespace) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="au-exact-local-gates-") as scratch_text:
        ...
        g35_source = _run_pytest_gate(
            ...
            selectors=(
                "unit/security/test_permissions_kernel.py::test_permissions_kernel_requires_explicit_strong_authority",
                "unit/security/test_permissions_kernel.py::TestAuthorization::test_non_empty_capabilities_are_additional_closed_world_grants",
                "unit/security/test_permissions_kernel.py::TestPolicyManagement::test_missing_configured_policy_fails_closed",
                "unit/security/test_permissions_kernel.py::TestPolicyManagement::test_malformed_policy_clears_existing_policy_set",
                "unit/security/test_permissions_kernel.py::TestPermissionContextBootstrap::test_resolves_reference_and_returns_verified_pair",
                "unit/security/test_permissions_kernel.py::TestPermissionContextBootstrap::test_missing_reference_fails_without_process_authority",
                "unit/security/test_permissions_kernel.py::TestPermissionContextBootstrap::test_injected_context_must_verify",
