...
**1229 LIVE** concepts (every entry in `docs/concepts.yaml` — the registry only carries concepts with shipped code) and **0 RESERVED** concept IDs (open, unexpired entries in `docs/concept_reservations.yaml`) across **9 pillars**.
...
| **AU-KG** — Epistemic Knowledge Graph | 526 | 0 | 0 | 0 | 0 |
| **AU-ORCH** — Graph Orchestration | 218 | 0 | 0 | 0 | 0 |
