...
- **Self-improvement may degenerate / saturate** → capability ratchet (AHE-3.24) + RSI velocity
  ledger (AHE-3.26) that flags a non-positive derivative.
...
- **The data wall** → distil the loop's own verified winning traces back into training data
  (OS-5.34), guarded against model collapse (SAFE-1.4).

## Status

Implemented + merged (local `main`): KG-2.67, KG-2.68, KG-2.69, SAFE-1.1, SAFE-1.3, SAFE-1.5,
AHE-3.22, AHE-3.23, AHE-3.24, AHE-3.26, OS-5.35. The DISTIL and SCALE stages (OS-5.34/AHE-3.25,
ORCH-1.46/47/48, SAFE-1.4) extend the same loop and are tracked in the gap-analysis report.
