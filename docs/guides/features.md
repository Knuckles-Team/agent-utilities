...
## First Principles Architecture (CONCEPT:ORCH-1.2 through CONCEPT:ECO-4.1)
...
### 13. PlannerGraphSkill (CONCEPT:ECO-4.1)
...
- `CONCEPT:ECO-4.1` — A2A PlannerGraphSkill (Graph-Native Routing)
