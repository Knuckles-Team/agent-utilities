...
- **Graph-Native Durable Execution (CONCEPT:ECO-4.0)**: Integrates DBOS-style fault-tolerant resumability natively into the epistemic-graph engine (the one database) for multi-leg algorithmic trading.
