...
- **ECO-4.10**: Agent Toolkit Ingestor — ingests Server/CallableResource nodes consumed by runner
- **ECO-4.11**: MCP Live Discovery — provides cached tool metadata for tool binding
