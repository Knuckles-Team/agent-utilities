...
> **CONCEPT:ORCH-1.15 through ORCH-1.19** — Dynamic, Knowledge-Graph-Driven Agent Orchestration
...
**CONCEPT:ORCH-1.15** — Replaces static `discover_agents()` registration with dynamic KG-topology-driven team assembly.
...
**CONCEPT:ORCH-1.17** — Materializes KG-stored topology templates into executable graphs.
...
**CONCEPT:ORCH-1.16** — Bridges ephemeral `GraphState` with persistent KG.
...
**CONCEPT:ORCH-1.18** — Routes using KG-derived topological signals instead of keyword TF-IDF.
...
**CONCEPT:ORCH-1.19** — Long-running KG-coordinated agents.
...
**CONCEPT:ORCH-1.15 Extension** — Export/import proven team configurations.
