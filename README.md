...
|:-:|:-------|:------|:--------:|:-----|
| 1 | Graph Orchestration | Planning, SDD lifecycle, dynamic multi-layer execution | 218 | [docs/pillars/1_graph_orchestration.md](docs/pillars/1_graph_orchestration.md) |
| 2 | Epistemic Knowledge Graph | The one engine authority — ingestion, ontology, ETL, reasoning | 526 | [docs/pillars/2_epistemic_knowledge_graph.md](docs/pillars/2_epistemic_knowledge_graph.md) |
