...
class TestAccessListModel:
    ...
    def test_access_list_json_schema(self):
        """access_list appears in the JSON schema with CONCEPT:AU-ORCH.execution.visibility-allow-list reference."""
        ...
        assert "CONCEPT:AU-ORCH.execution.visibility-allow-list" in desc
