...
def _skill_validation_evidence(
    *,
    ...
    unsigned: dict[str, object] = {
        ...
        "catalog": {
            "skillCount": check_compatibility._CURRENT_PREBUNDLED_SKILL_ENTRIES,
            "skillCatalogDigest": skill_catalog_digest,
            "testCaseCount": check_compatibility._CURRENT_PREBUNDLED_SKILL_CASES,
        ...
        "result": {
            "status": "pass",
            "passedCases": check_compatibility._CURRENT_PREBUNDLED_SKILL_CASES,
            "totalCases": check_compatibility._CURRENT_PREBUNDLED_SKILL_CASES,
            "fullyPassedSkills": check_compatibility._CURRENT_PREBUNDLED_SKILL_ENTRIES,
            "totalSkills": check_compatibility._CURRENT_PREBUNDLED_SKILL_ENTRIES,
        },
        "privacy": {
    ...
    *,
    ...
    unsigned: dict[str, object] = {
        ...
        "validation": {
            ...
            "caseCount": check_compatibility._CURRENT_PREBUNDLED_SKILL_CASES,
        },
        "result": "pass",
        "errorCode": None,
        "privacy": {
