"""ActorContextMiddleware bridges validated JWT → actor + GraphSession.
...
async def test_bridge_is_noop_without_claims():
    ...
    # Non-graph servers retain their own boundary; graph-os rejects the later
    # tool call because no verified session was minted.
