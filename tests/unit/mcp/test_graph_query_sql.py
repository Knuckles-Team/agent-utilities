"""graph_query scope='sql' — native SQL-on-the-KG over MCP (CONCEPT:KG-2.205).
...
pytestmark = pytest.mark.concept("KG-2.205")
...
# ── engine.sql() read-only guard + bridge (CONCEPT:KG-2.205) ──────────────────
