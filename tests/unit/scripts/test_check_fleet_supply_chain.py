...
def test_source_snapshot_mode_uses_exact_workspace_membership_without_git(
    ...
    assert POLICY.EXPECTED_SNAPSHOT_PROVIDERS == 71
...
# detect-private-key scanner, which has no sanitizer:ignore/marker support at
# all (unlike SC-SEC-002 below, which this file exists to test). Same
# convention scripts/security/check_secret_history.py's own self-check uses
# for its GITHUB_TOKEN fixture.
_SYNTHETIC_PEM_HEADER = "-----BEGIN " + "RSA PRIVATE KEY" + "-----"
