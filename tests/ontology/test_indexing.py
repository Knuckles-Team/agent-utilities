...
# tests/unit/graph/test_capability_designation.py to prove ObjectIndexFunnel
# adopts the same bootstrap-once + engine-subscription pattern rather than its
# own rebuild loop.
...
def test_poll_without_cdc_surface_falls_back_to_reconcile() -> None:
    ...
    reconcile pass over a fresh scan for a dev/non-engine backend."""
