...
def test_store_new_memory():
    ...
    node_id = memory_api.store_new_memory("user_123", "User likes Python", confidence=0.9)
...
def test_retrieve_personalized_context_with_decay():
    ...
    engine_mock.search_hybrid.return_value = [
        {"id": "fact_1", "user_id": "user_123", "content": "Valid fact", "valid_until": now + 10000},
        {"id": "fact_2", "user_id": "user_123", "content": "Decayed fact", "valid_until": now - 10000},
        {"id": "fact_3", "user_id": "other_user", "content": "Other user's fact", "valid_until": now + 10000},
    ]
    ...
    results = memory_api.retrieve_personalized_context("user_123", "query", top_k=5, max_hops=1)
...
def test_retrieve_fallback_cypher():
    ...
    engine_mock.query_cypher.return_value = [
        {"id": "fact_fb", "user_id": "user_123", "content": "Fallback fact", "valid_until": now + 10000}
    ]
    engine_mock.get_blast_radius.return_value = []
