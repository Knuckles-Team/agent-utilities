...
### intent-surface-condensed-collapse  (10 concepts)
    ...
    agent_utilities/mcp/multiplexer.py:4198 | # Split out the host server's OWN gated tools (CONCEPT·AU-ECO.mcp.intent-surface-condensed-collapse) —
...
### client-side-chat-session  (2 concepts)
    agent_utilities/knowledge_graph/retrieval/capabilities-power.json:23534 | "one_line": "Ingest AI agent chat/session history into the usage store + KG (CONCEPT·AU-ECO.mcp.client-side-chat-session). 'collect' auto-detects installed agents on THIS host and
...
### cross-process-skill-harvest  (2 concepts)
    ...
    agent_utilities/knowledge_graph/core/source_sync.py:497 | # CONCEPT·AU-ECO.mcp.cross-process-skill-harvest — promotion runs BEFORE the
...
### fleet-meta-tools-always-on
    ...
    agent_utilities/mcp/kg_server.py:4463 | # CONCEPT·AU-ECO.mcp.fleet-meta-tools-always-on
...
### fastmcp-middleware
    ...
    agent_utilities/mcp/middlewares.py:177 | CONCEPT·AU-ECO.mcp.fastmcp-middleware - Assimilated from FastMCP 'cross-cutting concern interception layer'.
...
### full-api-mcp-surface
    ...
    agent_utilities/mcp/kg_server.py:4002 | # The low-level engine_<domain> tools (CONCEPT·AU-ECO.mcp.full-api-mcp-surface) are generic
...
### kg-skill-verb-coverage
    ...
    .pre-commit-config.yaml:346 | # CONCEPT·AU-ECO.mcp.kg-skill-verb-coverage — third parity leg: every live
...
### profile-differences-from-client
    ...
    agent_utilities/mcp/multiplexer.py:3877 | """Register the always-present fleet-health meta-tool (CONCEPT·AU-ECO.mcp.profile-differences-from-client)."""
...
### protocol-compat-bridge
    ...
    pyproject.toml:162 | # fastmcp 4 is the default (CONCEPT·AU-ECO.mcp.protocol-compat-bridge). Empirically
    pyproject.toml:676 | # CONCEPT·AU-ECO.mcp.protocol-compat-bridge — fastmcp 4 is the default (see the
...
### tasks-workitem-bridge
    ...
    agent_utilities/mcp/server_factory.py:1614 | # CONCEPT·AU-ECO.mcp.tasks-workitem-bridge -- mount the native WorkItem-backed
...
### v2-gateway-otel-tracing
    why: a singleton: no sibling shares its source footprint or introducing commit (2 source file(s), 6 marker site(s))
    mcp_v2_gateway/pyproject.toml:8 | # CONCEPT·AU-ECO.mcp.v2-gateway-otel-tracing -- real span/trace export for the
    mcp_v2_gateway/tracing.py:3 | CONCEPT·AU-ECO.mcp.v2-gateway-otel-tracing
...
### webui-governed-mcp-delegation
    ...
    agent_utilities/server/app.py:828 | # CONCEPT·AU-ECO.mcp.webui-governed-mcp-delegation
